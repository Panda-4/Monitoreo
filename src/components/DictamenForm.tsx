              ...
              <div className="space-y-1 relative">
                ...
                <div className="flex gap-4 items-center mt-1">
                  <input 
                    ...
                    onChange={handleChange}
                    className="flex-1 bg-white/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-xl focus:ring-2 focus:ring-gem-primary/20 focus:border-gem-primary block p-3 transition-colors shadow-sm"
                  />
              ...
              <div className="space-y-1">
                ...
                <div className="relative flex items-center">
                  ...
                  <select 
                    ...
                    onChange={handleChange}
                    className="w-full bg-white/50 dark:bg-slate-900/50 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-xl focus:ring-2 focus:ring-gem-primary/20 focus:border-gem-primary block p-3 pl-9 transition-colors shadow-sm"
                  >
              ...
              <div className="space-y-6">
                <div className="space-y-1">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-white/80 dark:bg-slate-800/80 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-xl focus:ring-2 focus:ring-gem-primary/20 focus:border-gem-primary block p-3 transition-colors shadow-sm resize-none"
                  ></textarea>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4 bg-white/60 dark:bg-slate-800/60 p-5 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm">
                    <label className="block text-sm font-bold text-gray-800 flex items-center gap-2">
                       <CheckCircle className="w-4 h-4 text-green-600" /> ¿Es Procedente?
                    </label>
                    <div className="flex gap-4">
                      <label className="flex-1 flex items-center justify-center p-3 border rounded-lg cursor-pointer transition-all hover:bg-green-50 dark:hover:bg-green-900/30 ui-checked:bg-green-100 ui-checked:border-green-500 ui-checked:text-green-800 bg-white dark:bg-slate-800 dark:border-slate-600">
                      ...
                      <label className="flex-1 flex items-center justify-center p-3 border rounded-lg cursor-pointer transition-all hover:bg-red-50 dark:hover:bg-red-900/30 ui-checked:bg-red-100 ui-checked:border-red-500 ui-checked:text-red-800 bg-white dark:bg-slate-800 dark:border-slate-600">
                    ...
                    {formData.procedente === true && (
                      <div className="space-y-4 mt-4 pt-4 border-t border-gray-100 animate-in slide-in-from-top-2">
                        <div className="space-y-1">
                          ...
                          <input type="date" name="fechaEnvioAutorizacionOM" value={formData.fechaEnvioAutorizacionOM || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
                        </div>
                        <div className="space-y-1">
                          <label className="block text-xs font-semibold text-gray-600">Fecha de emisión de autorización</label>
                          <input type="date" name="fechaEmisionAutorizacion" value={formData.fechaEmisionAutorizacion || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
                        </div>
                        <div className="space-y-1">
                          <label className="block text-xs font-semibold text-gray-600">Fecha envío p/ firma DG</label>
                          <input type="date" name="fechaEnvioFirmaDG" value={formData.fechaEnvioFirmaDG || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
                        </div>
                        <div className="space-y-1">
                          <label className="block text-xs font-semibold text-gray-600">Fecha de envío a la Dependencia/ OPD</label>
                          <input type="date" name="fechaEnvioDependencia" value={formData.fechaEnvioDependencia || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
                        </div>
                      </div>
                    )}
                    ...
                    {formData.procedente === false && (
                      <div className="space-y-4 mt-4 pt-4 border-t border-gray-100 animate-in slide-in-from-top-2">
                        <div className="space-y-1">
                          ...
                          <input type="date" name="fechaEnvioRespuestaFirmaDG" value={formData.fechaEnvioRespuestaFirmaDG || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
                        </div>
                        <div className="space-y-1">
                          <label className="block text-xs font-semibold text-gray-600">Fecha de envío respuesta a la Dependencia/ OPD</label>
                          <input type="date" name="fechaEnvioRespuestaDependencia" value={formData.fechaEnvioRespuestaDependencia || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  {requiresSubformA && (
                    <div className="space-y-6">
                      {/* Antecedentes Sub A */}
                      <div className="bg-white/60 dark:bg-slate-800/60 p-5 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm space-y-4">
                         <label className="block text-sm font-bold text-gray-800">¿Cuenta con Dictamen Previo?</label>
                         <select name="cuentaDictamenPrevio" value={formData.cuentaDictamenPrevio || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5">
                            <option value="">Seleccione...</option>
                         ...
                         {formData.cuentaDictamenPrevio === "Sí" && (
                           <div className="grid grid-cols-2 gap-4 mt-3 animate-in slide-in-from-top-2">
                              <input type="date" name="fechaEmisionDictamenPrevio" placeholder="Fecha emisión" value={formData.fechaEmisionDictamenPrevio || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-sm rounded-lg p-2.5" title="Fecha de emisión de dictamen previo" />
                              <input type="text" name="numeroOficioDictamenPrevio" placeholder="N° de oficio" value={formData.numeroOficioDictamenPrevio || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-sm rounded-lg p-2.5" title="Oficio de dictamen previo"/>
                           </div>
                         )}
                      </div>
                      ...
                      <div className="bg-white/60 dark:bg-slate-800/60 p-5 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm space-y-4">
                         ...
                         <select name="cuentaExcepcionAusteridad" value={formData.cuentaExcepcionAusteridad || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5">
                            <option value="">Seleccione...</option>
                            <option value="Sí">Sí</option>
                            <option value="No">No</option>
                            <option value="N/A">N/A</option>
                         ...
                         {formData.cuentaExcepcionAusteridad === "Sí" && (
                           <div className="mt-3 animate-in slide-in-from-top-2">
                              <input type="date" name="fechaEmisionExcepcion" placeholder="Fecha emisión" value={formData.fechaEmisionExcepcion || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-sm rounded-lg p-2.5" title="Fecha emisión de excepción" />
                           </div>
                         )}
                      </div>
                      ...
                      <div className="bg-white/60 dark:bg-slate-800/60 p-5 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm space-y-4">
                        ...
                        <div className="relative">
                          ...
                          <input 
                            ...
                            onChange={handleChange}
                            placeholder="0.00"
                            className="w-full font-mono pl-8 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg focus:ring-2 focus:ring-gem-primary/20 focus:border-gem-primary block p-2.5 transition-colors shadow-sm"
                          />
                        </div>
                        <div className="space-y-1">
                          <label className="block text-xs font-semibold text-gray-600">Fecha de envío para autorización a la OM</label>
                          <input type="date" name="fechaEnvioAutorizacionOM_A" value={formData.fechaEnvioAutorizacionOM_A || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
                        </div>
                        ...
                        <select name="cuentaAutorizacionOM" value={formData.cuentaAutorizacionOM?.toString() || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5">
                           <option value="">Seleccione...</option>
                        ...
                        {formData.cuentaAutorizacionOM === true && (
                          <div className="space-y-3 mt-3 animate-in slide-in-from-top-2 border-t border-gray-100 pt-3">
                             <div className="space-y-1">
                               ...
                               <input type="text" name="numeroOficioAutorizacion" value={formData.numeroOficioAutorizacion || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
                             </div>
                             <div className="space-y-1">
                               <label className="block text-xs font-semibold text-gray-600">Fecha de envío de respuesta de OM a la DGRM</label>
                               <input type="date" name="fechaEnvioRespuestaOM_DGRM" value={formData.fechaEnvioRespuestaOM_DGRM || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
                             </div>
                             <div className="space-y-1">
                               <label className="block text-xs font-semibold text-gray-600">Fecha de recepción en la DGRM</label>
                               <input type="date" name="fechaRecepcionDGRM" value={formData.fechaRecepcionDGRM || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
                             </div>
                             <div className="space-y-1">
                               <label className="block text-xs font-semibold text-gray-600">Fecha de respuesta de DGRM a la Dependencia/OPD</label>
                               <input type="date" name="fechaRespuestaDGRM_Dependencia" value={formData.fechaRespuestaDGRM_Dependencia || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
                             </div>
                          </div>
                        )}
                        ...
                        {formData.cuentaAutorizacionOM === false && (
                          <div className="space-y-3 mt-3 animate-in slide-in-from-top-2 border-t border-gray-100 pt-3">
                             <div className="space-y-1">
                               ...
                               <input type="text" name="numeroOficioRespuesta" value={formData.numeroOficioRespuesta || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
                             </div>
                             <div className="space-y-1">
                               <label className="block text-xs font-semibold text-gray-600">Fecha de envío de respuesta de OM a la DGRM</label>
                               <input type="date" name="fechaEnvioRespuestaOM_DGRM" value={formData.fechaEnvioRespuestaOM_DGRM || ''} onChange={handleChange} className="w-full bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-lg p-2.5" />
          ...
          {requiresSubformC && (
            <section className="bg-gem-secondary/10 rounded-2xl p-6 border border-gem-secondary/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1">
                  <label className="block text-sm font-semibold text-gray-700 dark:text-slate-300">Tipo de Excepción</label>
                  <select name="tipoExcepcion" value={formData.tipoExcepcion || ''} onChange={handleChange} className="w-full bg-white/80 dark:bg-slate-800/80 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-xl p-3">
                    <option value="">Seleccione...</option>
                ...
                <div className="space-y-1">
                  <label className="block text-sm font-semibold text-gray-700 dark:text-slate-300">Monto de Suficiencia Presupuestal</label>
                  <input type="number" name="montoSuficienciaPresupuestal" value={formData.montoSuficienciaPresupuestal || ''} onChange={handleChange} className="w-full bg-white/80 dark:bg-slate-800/80 border border-gray-200 dark:border-slate-600 font-mono text-sm rounded-xl p-3" />
                </div>
                <div className="space-y-1 md:col-span-2">
                  <label className="block text-sm font-semibold text-gray-700 dark:text-slate-300">Descripción detallada</label>
                  <textarea name="descripcionExcepcion" value={formData.descripcionExcepcion || ''} onChange={handleChange} rows={3} className="w-full bg-white/80 dark:bg-slate-800/80 border border-gray-200 dark:border-slate-600 text-gray-800 dark:text-slate-100 text-sm rounded-xl p-3"></textarea>
                </div>
                
                 <div className="space-y-4 bg-white/60 dark:bg-slate-800/60 p-5 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm mt-4">
                    <label className="block text-sm font-bold text-gray-800 flex items-center gap-2">
                       <CheckCircle className="w-4 h-4 text-green-600" /> ¿Es Procedente?
                    </label>
                    <div className="flex gap-4">
                      <label className={`flex-1 flex items-center justify-center p-3 border rounded-lg cursor-pointer transition-all hover:bg-green-50 dark:hover:bg-green-900/30 bg-white dark:bg-slate-800 dark:border-slate-600 ${formData.procedente === true ? 'bg-green-100 border-green-500 text-green-800' : ''}`}>
                        <input type="radio" name="procedente" value="true" checked={formData.procedente === true} onChange={handleChange} className="sr-only" />
                        <span className="font-medium text-sm">Sí</span>
                      </label>
                      <label className={`flex-1 flex items-center justify-center p-3 border rounded-lg cursor-pointer transition-all hover:bg-red-50 dark:hover:bg-red-900/30 bg-white dark:bg-slate-800 dark:border-slate-600 ${formData.procedente === false ? 'bg-red-100 border-red-500 text-red-800' : ''}`}>
                        <input type="radio" name="procedente" value="false" checked={formData.procedente === false} onChange={handleChange} className="sr-only" />
                ...
                <div className="space-y-1 mt-4">
                  <label className="block text-sm font-semibold text-gray-700 dark:text-slate-300">Fecha de Respuesta</label>
                  <input type="date" name="fechaRespuestaExcepcion" value={formData.fechaRespuestaExcepcion || ''} onChange={handleChange} className="w-full bg-white/80 dark:bg-slate-800/80 border border-gray-200 dark:border-slate-600 text-sm dark:text-slate-100 rounded-xl p-3" />
                </div>
              </div>
            </section>
          )}
